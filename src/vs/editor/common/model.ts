...
export class TextModelResolvedOptions {
	...
	constructor(src: {
		...
		//this.indentEmptyLines = true; // Boolean(src.indentEmptyLines); <SPH>
	...
	public equals(other: TextModelResolvedOptions): boolean {
		return (
			...
			//&& this.indentEmptyLines === other.indentEmptyLines <SPH>
	...
	public createChangeEvent(newOpts: TextModelResolvedOptions): IModelOptionsChangedEvent {
		return {
			...
			//indentEmptyLines: this.indentEmptyLines !== newOpts.indentEmptyLines, <SPH>
